...
def Breadth_First_Search_graph_path_find(nodes, pos_player, destination_row, move):
...
def Greedy_Best_First_Search_graph_path_find(nodes, pos_player, destination_row, move):
    board_nodes = copy.deepcopy(nodes)
    pos = move[0]
