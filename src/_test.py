...
def compare_moves(repeats, repr_1, repr_2, search_1, search_2):
    for repeat in range(repeats):
        ...
        while not over:
            ...
            shared_action = g_one.select(one_available_moves)
...
if __name__ == "__main__":
    # compare_moves(10, "graph_optim", "graph", "BFS", "BFS")
    # compare_moves(10, "graph_optim", "bitboard", "BFS", "BFS")
