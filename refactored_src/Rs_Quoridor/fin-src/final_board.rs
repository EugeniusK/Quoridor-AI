pub mod final_board {
    ...
    pub const RUST_DYNAMIC_GRAPH_BLANK: RustBoard = RustBoard {
        nodes: [[false; 4]; 81],
        p1_pos: 0,
        p2_pos: 0,
        p1_walls_placed: 0,
    ...
    impl RustBoard {
        pub fn undo_action(&mut self, action: i16) {
            if action < 128 {
                if action < 64 {
        ...
        pub fn is_direction_valid(&self, pos: i16, direction: i16) -> bool {
            self.nodes[pos as usize][direction as usize]
        }

        pub fn is_move_valid(&self, move_number: i16) -> bool {
            let in_turn_pos: i16;
        ...
        pub fn is_wall_valid(&self, wall_number: i16) -> bool {
            if wall_number < 64 {
                if wall_number % 8 == 0 {
        ...
        pub fn can_place_wall(&self) -> bool {
            (self.turn == 1 && self.p1_walls_placed < 10)
                | (self.turn == 2 && self.p2_walls_placed < 10)
        }
        pub fn get_pos(&self, player_number: i16) -> i16 {
            if player_number == 1 {
                self.p1_pos
            } else {
                self.p2_pos
        ...
        pub fn search(&self, player_number: i16) -> [i16; 81] {
            if self.mode == 1 {
                if player_number == 1 {
        ...
        pub fn number_actions(&self) -> i16 {
            140
        }
        pub fn display(&self) -> () {
        ...
        pub fn bfs(&self, start_pos: i16, player_number: i16) -> [i16; 81] {
        ...
        pub fn dfs(&self, start_pos: i16, player_number: i16) -> [i16; 81] {
            let mut frontier: [i16; 81] = [-1; 81];
        ...
        pub fn gbfs(&self, start_pos: i16, player_number: i16) -> [i16; 81] {
            let mut frontier: [i16; 81] = [-1; 81];
        ...
        pub fn astar(&self, start_pos: i16, player_number: i16) -> [i16; 81] {
        ...
        pub fn is_action_available(&mut self, action_number: i16) -> bool {
        ...
        pub fn get_available_actions_slow(&mut self) -> Vec<i16> {
        ...
        pub fn get_available_actions_fast(&mut self) -> Vec<i16> {
            let mut available_actions: Vec<i16> = vec![];
        ...
        pub fn get_valid_actions(&mut self, mode: i16) -> Vec<i16> {
            if mode == 1 {
                RustBoard::get_available_actions_slow(self)
            } else if mode == 2 {
                RustBoard::get_available_actions_fast(self)
            } else {
                RustBoard::get_available_actions_fast(self)
            }
        }

        pub fn new(mode: i16) -> RustBoard {
            RustBoard {
                nodes: [
        ...
        pub fn take_action(&mut self, action: i16) {
            if action < 128 {
                if action < 64 {
        ...
        pub fn get_turn(&self) -> i16 {
            self.turn
        }
        pub fn is_over(&self) -> bool {
            self.over
        }
        pub fn get_random_action(&mut self) -> i16 {
